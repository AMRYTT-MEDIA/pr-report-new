...
export const canAccessUsers = (user) => {
  return hasPermission(user, "canAccessUsers");
};
...
export const canAccessReports = (user) => {
  return hasPermission(user, "canAccessReports");
};
 ...
 * @returns {boolean}
 */
export const canAccessWebsite = (user) => {
  return hasPermission(user, "canAccessWebsite");
};
...
export const canManageWebsite = (user) => {
  return hasPermission(user, "canManageWebsite");
};
 ...
 * @returns {boolean}
 */
export const canDeleteReports = (user) => {
  return hasPermission(user, "canDeleteReports");
};
