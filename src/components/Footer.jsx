    ...
    <footer className="bg-foreground text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-white/80 leading-relaxed">
              Premium link building and PR distribution agency helping
              businesses grow their online presence through strategic media
              coverage and quality backlinks.
            </p>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 text-center text-white/60">
          <p>
            &copy; 2024 GUESTPOSTLINKS. All rights reserved. Premium Link
            Building & PR Distribution Agency.
          </p>
        </div>
      </div>
    </footer>
