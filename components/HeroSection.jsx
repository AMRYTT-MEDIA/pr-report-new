  ...
  <section className="bg-gradient-hero text-white py-20 relative overflow-hidden">
        ...
        <div className="space-y-6 lg:space-y-8 xl:space-y-10 2xl:space-y-12">
          ...
          <div className="space-y-4 lg:space-y-6 xl:space-y-8 2xl:space-y-10">
            ...
            <p className="text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl text-white/90 leading-relaxed max-w-3xl">
              Boost your <strong>brand credibility</strong>, <strong>media coverage</strong>, and{" "}
              <strong>online authority</strong> with professional press release distribution to major news outlets,
    ...
    <div className="absolute bottom-0 left-0 right-0">
      <svg className="w-full h-20 text-white" viewBox="0 0 1200 120" preserveAspectRatio="none">
        <path d="M0,0V120L1200,120V0C1200,0 800,80 400,40C200,20 0,60 0,0Z" fill="currentColor" />
      </svg>
    </div>
  </section>
);
