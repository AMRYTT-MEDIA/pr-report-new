...
const Pagination = ({
  ...
  return (
    <div
      className={`px-6 py-4 flex justify-center items-center border-t md:flex-row flex-col gap-8 ${className}`}
      style={{
        color: "#475569",
        fontSize: "14px",
        fontWeight: "500",
      ...
      <div className="flex items-center md:gap-4 gap-2">
        ...
        <div className="flex items-center md:gap-2 gap-1">
          {getVisiblePages().map((page, index) => (
            <div
              key={index}
              className={`flex items-center md:px-3 px-2 cursor-pointer ${
